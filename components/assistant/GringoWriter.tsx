  ...
  return (
    <div className="flex items-start gap-3">
      <div className="flex-shrink-0 mt-1">
        <CV1Character mood={isLatest && !typeDone ? "talking" : "idle"} size={64} variant={charVariant} />
      </div>
    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          <CV1Character mood={loading ? "thinking" : isDone ? "celebrate" : "talking"} size={84} variant={charVariant} />
          <div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        {loading && (
          <div className="flex items-center gap-3">
            <CV1Character mood="thinking" size={64} variant={charVariant} />
        ...
        {isDone && (
          ...
          >
            <CV1Character mood="celebrate" size={120} variant={charVariant} />
