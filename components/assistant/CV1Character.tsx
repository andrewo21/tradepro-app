...
const CV1_BUST: Record<CV1Mood, string> = {
  idle:      "/cv1-bust.png?v=2",
  wave:      "/cv1-bust-wave.png?v=2",
  talking:   "/cv1-bust-talking.png?v=2",
  thinking:  "/cv1-bust-thinking.png?v=2",
  happy:     "/cv1-bust-thinking.png?v=2",
  celebrate: "/cv1-bust-celebrate.png?v=2",
  polish:    "/cv1-bust-thinking.png?v=2",
  shrug:     "/cv1-bust.png?v=2",
};
