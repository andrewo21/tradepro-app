...
// GringoViewer — renders gringo.glb in a Three.js Canvas.
// Loaded dynamically with ssr:false to avoid WebGL server-side crash.

import { useRef, useEffect } from "react";
import { Canvas, useFrame } from "@react-three/fiber";
import { useGLTF, useAnimations, OrbitControls, Environment, ContactShadows, PresentationControls } from "@react-three/drei";
...
function GringoModel() {
  ...
  useEffect(() => {
    // Play the first animation found (idle, wave, etc.)
  ...
  // Gentle auto-rotate when no animations exist
  useFrame((_, delta) => {
...
export default function GringoViewer({ size = 320 }: { size?: number }) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <directionalLight position={[-2, 2, -2]} intensity={0.3} color="#22c55e" />
