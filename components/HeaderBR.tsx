        ...
        <div className="relative">
          ...
          {open && (
            <div className="absolute right-0 mt-2 w-56 bg-white border rounded-md shadow-lg py-2 text-sm z-50">
              ...
              <Link href="/br/ats" className="block px-4 py-2 text-neutral-800 hover:bg-neutral-100">Análise ATS</Link>
              ...
              <div className="border-t border-neutral-100 mt-1 pt-1">
                <Link href="/br/meus-curriculos" className="block px-4 py-2 text-green-700 font-medium hover:bg-green-50">Minha Conta / Currículos Salvos</Link>
              </div>
              <div className="border-t border-neutral-100 mt-1 pt-1">
