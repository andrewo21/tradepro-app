        ...
        bullets.map((line, idx) =>
          React.createElement(
            ...
            React.createElement("span", {
              className:
                "mt-[5px] h-[3px] w-[3px] rounded-full bg-gray-700",
            }),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        {
          className:
            "max-w-3xl mx-auto px-8 py-5 flex items-center justify-between gap-6",
        },
        React.createElement(
          "div",
          null,
          ...
          React.createElement(
            "p",
            { className: "text-[12px] text-gray-200 mt-1" },
            title
          )
        ),
        React.createElement(
          "div",
          { className: "text-[10px] text-right space-y-0.5 text-gray-200" },
        ...
        React.createElement(
          ...
          summary &&
            React.createElement(
              "section",
              null,
              React.createElement(SectionHeader, { title: "Summary" }),
              React.createElement(
                "p",
          ...
          skills.length > 0 &&
            React.createElement(
              "section",
              null,
              React.createElement(SectionHeader, { title: "Skills" }),
              React.createElement(
                "ul",
