...
const SidebarHeader = ({ title }) =>
  React.createElement(
    ...
    {
      className:
        "text-[11px] font-serif font-semibold uppercase tracking-wide text-gray-900 border-b border-gray-700 pb-1",
    },
    title
  );
...
const MainHeader = ({ title }) =>
  React.createElement(
    ...
    {
      className:
        "text-[12px] font-serif font-semibold uppercase tracking-wide text-gray-900 border-b border-gray-400 pb-1",
    },
    title
  );
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "font-serif font-semibold text-[11px]" },
          job.jobTitle
        ),
        React.createElement(
          "div",
        ...
        bullets.map((line, idx) =>
          React.createElement(
            ...
            React.createElement("span", {
              className: "mt-[5px] h-[3px] w-[3px] rounded-full bg-black",
            }),
...
module.exports = function ExecutiveLuxe({
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "h1",
        { className: "text-[20px] font-serif font-semibold leading-tight" },
        name
      ),
      React.createElement(
        "p",
        { className: "text-[11px] text-gray-800 mt-1 font-serif" },
        title
      ),

      React.createElement(
        "div",
        { className: "mt-4 space-y-1 text-[10px] text-gray-800" },
