        ...
        bullets.map((line, idx) =>
          React.createElement(
            ...
            React.createElement("span", {
              className:
                "mt-[5px] h-[3px] w-[3px] rounded-full bg-gray-800",
            }),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        {
          className:
            "flex justify-center gap-4 text-[10px] text-gray-600 mt-2",
        },
        location && React.createElement("span", null, location),
        email && React.createElement("span", null, email),
        phone && React.createElement("span", null, phone),
        linkedin &&
          React.createElement("span", { className: "break-all" }, linkedin)
      )
    ),
