...
export const useResumeStore = create<any>()(
  persist((set, get) => ({
    ...
    rewriteResponsibility: async (id: string, idx: number) => {
      ...
      set((state: any) => ({ 
        experience: state.experience.map((e: any) => e.id === id ? { 
          ...e, responsibilities: e.responsibilities.map((r: any, i: number) => i === idx ? { ...r, loading: true } : r) 
        } : e) 
      }));
      try {
        const res = await fetch(`${API_BASE}/api/ai/rewrite`, { 
        ...
        set((state: any) => ({ 
          experience: state.experience.map((e: any) => e.id === id ? { 
            ...e, responsibilities: e.responsibilities.map((r: any, i: number) => i === idx ? { ...r, loading: false, suggestion: sanitize(data.suggestion) } : r) 
          } : e) 
        }));
      } catch (e) { 
        set((state: any) => ({ 
          experience: state.experience.map((e: any) => e.id === id ? { 
            ...e, responsibilities: e.responsibilities.map((r: any, i: number) => i === idx ? { ...r, loading: false } : r) 
          } : e) 
        })); 
      }
    },
    ...
    // Achievement logic correctly finished
    ...
    rewriteAchievement: async (id: string, idx: number) => {
      ...
      set((state: any) => ({ 
        experience: state.experience.map((e: any) => e.id === id ? { 
          ...e, achievements: e.achievements.map((a: any, i: number) => i === idx ? { ...a, loading: true } : a) 
        } : e) 
      }));
      try {
        const res = await fetch(`${API_BASE}/api/ai/rewrite`, { 
        ...
        set((state: any) => ({ 
          experience: state.experience.map((e: any) => e.id === id ? { 
            ...e, achievements: e.achievements.map((a: any, i: number) => i === idx ? { ...a, loading: false, suggestion: sanitize(data.suggestion) } : a) 
          } : e) 
        }));
      } catch (e) { 
        set((state: any) => ({ 
          experience: state.experience.map((e: any) => e.id === id ? { 
            ...e, achievements: e.achievements.map((a: any, i: number) => i === idx ? { ...a, loading: false } : a) 
          } : e) 
        })); 
      }
    },
