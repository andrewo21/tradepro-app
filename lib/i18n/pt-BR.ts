  ...
  pricing: {
    ...
    bundle: {
      ...
      features: [
        ...
        "Escrita assistida por IA em português",
        "Edite até ficar satisfeito",
        "3 downloads em PDF por ferramenta",
        "Carta de Apresentação incluída",
        "Portfólio de Obras incluído",
      ],
    },
    footer: "Compra única por sessão. Edite livremente — 3 downloads em PDF incluídos por ferramenta.",
